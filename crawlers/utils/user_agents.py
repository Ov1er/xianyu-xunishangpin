...
class UserAgentPool:
    ...
    def get_desktop(self) -> str:
        desktop_uas = [ua for ua in self._USER_AGENTS if 'iPhone' not in ua and 'Android' not in ua]
        return random.choice(desktop_uas)
    
    def get_mobile(self) -> str:
        mobile_uas = [ua for ua in self._USER_AGENTS if 'iPhone' in ua or 'Android' in ua]
        if mobile_uas:
